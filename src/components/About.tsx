      ...
      <section id="about" className="border border-gray-300 rounded-md">
        ...
        <ul>
          <li>
            ...
            , &nbsp;
            <a
              href="https://www.gallup.com/cliftonstrengths/en/252350/strategic-theme.aspx"
              target="_blank"
              rel="noreferrer"
            >
              Strategic
          ...
          <li>
            ...
            <ul className="pl-5">
              <li>
                Highest dimension:{" "}
                <a
                  href="https://www.discprofiles4u.com/pages/disc-behavioral-styles"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li>
                Classical Pattern:{" "}
                <a
                  href="https://www.discprofiles4u.com/blog/2012/disc-classic-2-perfectionist-pattern-15-of-16/"
                  target="_blank"
                  rel="noreferrer"
                >
                  Perfectionist
